...
local function isinstanceof(obj, cls)
	return isobject(obj) and isclass(cls) and (obj.__class == cls or (obj.__super and isinstanceof(obj.__super, cls)))
end
...
local new_class_internal = function(name, parentclass, classdef)
	...
	local cls = {
		...
		__classdef = parentclass and setmetatable(classdef, { __index = parentclass.__classdef }) or classdef,
